...
import com.yun.psychology.constant.CommonConstant;
import com.yun.psychology.exception.ThrowUtils;
import com.yun.psychology.mapper.QuestionMapper;
import com.yun.psychology.model.dto.question.QuestionQueryRequest;
import com.yun.psychology.model.entity.Question;
//import com.yun.psychology.model.entity.QuestionFavour;
//import com.yun.psychology.model.entity.QuestionThumb;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements QuestionService {
    ...
    public QueryWrapper<Question> getQueryWrapper(QuestionQueryRequest questionQueryRequest) {
        ...
        // todo 补充需要的查询条件
        // 外键查询
        if (questionBankId != null) {   // 根据题库id查询题目
            LambdaQueryWrapper<QuestionBankQuestion> lambdaQueryWrapper = Wrappers.lambdaQuery(QuestionBankQuestion.class);
            lambdaQueryWrapper.select(QuestionBankQuestion::getQuestionId).eq(QuestionBankQuestion::getQuestionBankId, questionBankId);
            List<QuestionBankQuestion> questionBankQuestionList = questionBankQuestionService.list(lambdaQueryWrapper);
            List<Long> questionIdList = questionBankQuestionList.stream().map(QuestionBankQuestion::getQuestionId).collect(Collectors.toList());

            queryWrapper.in(CollUtil.isNotEmpty(questionIdList),"id", questionIdList);
        }
