...
import com.yun.psychology.mapper.QuestionBankQuestionMapper;
...
public class QuestionBankQuestionServiceImpl extends ServiceImpl<QuestionBankQuestionMapper, QuestionBankQuestion> implements QuestionBankQuestionService {
    ...
    public void validQuestionBankQuestion(QuestionBankQuestion questionBankQuestion, boolean add) {
        ThrowUtils.throwIf(questionBankQuestion == null
                || questionBankQuestion.getQuestionId() <= 0
                || questionBankQuestion.getQuestionBankId() <= 0, ErrorCode.PARAMS_ERROR);
    ...
    public QueryWrapper<QuestionBankQuestion> getQueryWrapper(QuestionBankQuestionQueryRequest questionBankQuestionQueryRequest) {
        ...
        queryWrapper.eq(ObjectUtils.isEmpty(questionBankId), "questionBankId", questionBankId);
        queryWrapper.eq(ObjectUtils.isEmpty(questionId), "questionId", questionId);
